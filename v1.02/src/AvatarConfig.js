...
export const NOSE_SCALE_MIN = 0.7;
export const NOSE_SCALE_MAX = 1.35;
export const NOSE_WIDTH_MIN = 0.65;
export const NOSE_WIDTH_MAX = 1.75;
...
export const DEFAULT_CONFIG = Object.freeze({
  ...
  nose: { style: "button", scale: 1.0, width: 1.05 },
  mouth: {
    style: "smile",
    scale: 0.62,
    lipThickness: 0.7,
...
export function randomConfig(seed = Math.random()) {
  ...
  return resolveConfig({
    ...
    ears: { style: pick(EAR_STYLES), scale: 0.95 + rnd() * 0.4 },
