...
function buildLookControls() {
  ...
  rangeField("Nose length", NOSE_SCALE_MIN, NOSE_SCALE_MAX, 0.05, () => c.nose.scale ?? 1, (v) => {
    c.nose.scale = v;
  }, "nose.scale");
  rangeField("Nose width", NOSE_WIDTH_MIN, NOSE_WIDTH_MAX, 0.05, () => c.nose.width ?? 1.05, (v) => {
    c.nose.width = v;
  }, "nose.width");
